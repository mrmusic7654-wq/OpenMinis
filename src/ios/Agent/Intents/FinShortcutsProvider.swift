...
/// Siri trigger phrases (zh-Hans/zh-Hant, e.g. "问问Fin") live in
...
@available(iOS 17.0, *)
struct FinShortcutsProvider: AppShortcutsProvider {
    static var appShortcuts: [AppShortcut] {
        // Siri-facing "ask Fin" entry — opens the app and lands in the
