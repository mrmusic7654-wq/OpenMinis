...
//
// The FinTests target compiles a few production sources directly (ContextPolicy,
...
// FinTests synchronized folder, so it is compiled ONLY into the test bundle and
