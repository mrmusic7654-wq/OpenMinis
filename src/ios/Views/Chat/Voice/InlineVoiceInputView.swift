...
struct InlineVoiceInputView: View {
    ...
    private var expandedBody: some View {
        VStack(spacing: 8) {
            ...
            // FinToast instead of an inline pill here — the pill inserted a
    ...
    private var correctionButton: some View {
        ...
        .alert(String(localized: "Improve voice corrections?",
            ...
            Text("Fin can store your transcript fixes (original → corrected pairs) and accepted AI corrections in a local on-device database to make future voice corrections smarter. Nothing is uploaded. You can change this or clear the data anytime in Settings → Permissions.",
            ...
            await MainActor.run {
                ...
                if suggestion.hasChange {
                    ...
                    if reason == "llm_timeout" || reason.hasPrefix("llm_error") {
                        ...
                        FinToast.show(String(localized: "Correction failed, original kept",
                        ...
                        FinToast.show(String(localized: "No corrections needed",
