...
final class AppGroupChangeWatcher {
    ...
    private let queue = DispatchQueue(label: "com.mrmusic.fin.fpwatcher", qos: .utility)
    private let domainIdentifier = NSFileProviderDomainIdentifier("com.mrmusic.fin.files")
