...
enum FPSyncTraceLog {
    ...
    private static let queue = DispatchQueue(label: "com.mrmusic.fin.FileProvider.fpSyncTrace")
    private static let osLog = OSLog(subsystem: "com.mrmusic.fin.FileProvider", category: "FPSyncTrace")
