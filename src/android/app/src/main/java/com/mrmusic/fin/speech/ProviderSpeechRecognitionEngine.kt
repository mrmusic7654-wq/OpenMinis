package com.mrmusic.fin.speech
...
import com.mrmusic.fin.provider.voice.VoiceInputRequest
import com.mrmusic.fin.provider.voice.VoiceProvider
import com.mrmusic.fin.provider.voice.VoiceProviderException
import com.mrmusic.fin.provider.voice.VoiceProviderFactory
...
class ProviderSpeechRecognitionEngine(private val appContext: Context) : SpeechRecognitionEngine {
    ...
    private fun repository() =
        (appContext.applicationContext as? FinApp)
    ...
    private fun startVadCapture(
        locale: Locale,
        repo: com.mrmusic.fin.data.repository.ProviderRepository,
        candidates: List<Pair<com.mrmusic.fin.data.model.ProviderInstance, com.mrmusic.fin.data.model.ModelEntry>>,
