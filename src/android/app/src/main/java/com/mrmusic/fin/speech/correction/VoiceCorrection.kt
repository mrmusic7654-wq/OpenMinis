package com.mrmusic.fin.speech.correction

import android.content.Context
import android.util.Log
import com.mrmusic.fin.FinApp
import com.mrmusic.fin.shared.TextSegmenter
...
object VoiceCorrection {
    ...
    fun ensureInitialized(context: Context) {
        ...
        // FinApp — AppDatabase.getInstance is already the shared handle.
        val dao = runCatching {
            com.mrmusic.fin.data.db.AppDatabase.getInstance(app).chatDao()
        }.getOrNull()
        if (dao != null) {
    ...
    fun buildConversationContext(
        context: Context,
        messages: List<com.mrmusic.fin.ui.chat.ChatMessage>,
    ): ConversationContext {
        ensureInitialized(context)
