...
import com.mrmusic.fin.offload.ShizukuBackend
 ...
 *                        installed manager.
 *   NEED_PERMISSION   → "Authorize Fin" CTA → triggers system dialog.
        ...
        SettingsSection(
            ...
            SettingsRow(
                ...
                subtitle = if (snap.state == ShizukuManager.State.READY) {
                    ...
                    // user can see their root module is what's serving Fin.
                    if (snap.isSui) {
