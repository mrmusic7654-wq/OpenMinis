...
import com.mrmusic.fin.power.PowerOptimizationManager
...
fun SystemPermissionsScreen(onBack: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        while (true) {
            ...
            val connected = FinAccessibilityService.getInstance() != null
    ...
    Scaffold(
        ...
        Column(
            ...
            var correctionEnabled by remember {
                mutableStateOf(
                    com.mrmusic.fin.speech.correction.VoiceCorrectionConsent.isEnabled(context),
                )
            }
