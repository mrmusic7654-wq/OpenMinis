...
fun FinMenu(
    ...
    // AnimatedVisibility so every FinMenu gets the same iOS 26-style
...
/**
 * Subtle inset divider for grouping items inside a [FinMenu]. T289:
 ...
 */
@Composable
fun FinMenuDivider(modifier: Modifier = Modifier) {
