...
import com.mrmusic.fin.ui.components.SettingsRowDivider
import com.mrmusic.fin.ui.components.SettingsSection
...
fun RootfsManagementScreen(
    ...
    if (showResetDialog) {
        AlertDialog(
            ...
            dismissButton = {
                FinTextButton(onClick = { showResetDialog = false }) {
    ...
    if (showResetBackupDialog) {
        AlertDialog(
            ...
            dismissButton = {
                FinTextButton(onClick = { showResetBackupDialog = false }) {
                    Text(stringResource(R.string.common_cancel))
                }
            },
        )
