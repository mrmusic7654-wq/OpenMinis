                ...
                r = OffloadPermissionManager.requestSettingsGate(
                    OffloadPermissionManager.SettingsGateRequest(
                        ...
                        message = if (needsWrite) {
                            "Fin needs read + write contacts permission to delete entries. Open Settings to allow it."
                        } else {
                            "Fin needs contacts permission to read your address book. Open Settings to allow it."
                        },
