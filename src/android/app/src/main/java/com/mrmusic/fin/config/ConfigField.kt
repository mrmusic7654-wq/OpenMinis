...
/**
 * One configurable setting. Concrete kinds: [com.mrmusic.fin.config.fields.PrefsBoolField]
 * etc. for SharedPreferences-backed scalars; [com.mrmusic.fin.config.fields.ClosureField]
