...
import com.mrmusic.fin.ui.components.openExternalUrl
...
private fun buildBugReportUrl(): String {
    ...
    val body = """
        ...
        | Fin Version | $versionName (build $versionCode) |
...
private fun buildFeedbackMailto(): String {
    ...
    """.trimIndent()
    val subject = java.net.URLEncoder.encode("Fin Feedback", "UTF-8")
    val encodedBody = java.net.URLEncoder.encode(body, "UTF-8")
