...
fun FinButton(
    ...
    Button(
        onClick = onClick,
        modifier = modifier.heightIn(min = FinButtonHeight),
        enabled = enabled,
        shape = shape,
        colors = colors,
        elevation = elevation,
...
// defaultMinSize is also pinned at FinSmallButtonHeight so Material3's
...
fun FinSmallButton(
    ...
    Button(
        onClick = onClick,
        modifier = modifier
            .heightIn(min = FinSmallButtonHeight)
            .defaultMinSize(minHeight = FinSmallButtonHeight),
        enabled = enabled,
        shape = shape,
        colors = colors,
        elevation = elevation,
