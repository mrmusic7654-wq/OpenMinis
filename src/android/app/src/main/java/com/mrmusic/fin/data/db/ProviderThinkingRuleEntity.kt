 ...
 * in [com.mrmusic.fin.provider.thinking.ThinkingRuleResolver.builtInRules] and are
...
data class ProviderThinkingRuleEntity(
    ...
    /** Serialized [com.mrmusic.fin.provider.thinking.ThinkingWireFormat]; null = "no opinion". */
