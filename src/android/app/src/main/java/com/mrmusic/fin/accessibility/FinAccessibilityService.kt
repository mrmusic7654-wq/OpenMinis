...
/**
 * FinAccessibilityService — host-side AccessibilityService backing the
 ...
 */
class FinAccessibilityService : AccessibilityService() {

    companion object {
        private const val TAG = "FinA11y"
        const val SERVICE_ID = "com.mrmusic.fin/.accessibility.FinAccessibilityService"
        private const val EVENT_RING_CAP = 1024

        @Volatile
        private var _instance: FinAccessibilityService? = null

        fun getInstance(): FinAccessibilityService? = _instance
    }
