package com.mrmusic.fin.providers
 ...
 * ```xml
 * <provider android:name=".providers.FinDocumentsProvider"
 ...
 * Files app.
 */
class FinDocumentsProvider : DocumentsProvider() {
    ...
    override fun queryDocument(documentId: String, projection: Array<String>?): Cursor {
        ...
        val displayName = if (documentId.isEmpty()) "Fin" else file.name
        cursor.newRow()
