...
// Resolved from LocalChatPalette, which is provided by FinTheme.
//
// iOS reference:
...
// [T-app-themes] The active visual theme, provided by FinTheme. Screens that
// need theme-specific decoration (e.g. the picker's live preview) read this;
// everything else should keep going through MaterialTheme / ChatColors so it
