package com.mrmusic.fin.config.collections

import com.mrmusic.fin.config.ConfigCollection
import com.mrmusic.fin.config.ConfigError
import com.mrmusic.fin.config.ConfigField
import com.mrmusic.fin.config.ConfigRisk
import com.mrmusic.fin.config.ConfigSchema
import com.mrmusic.fin.config.ConfigValue
import com.mrmusic.fin.config.fields.ClosureField
import com.mrmusic.fin.config.fields.HiddenField
...
class ProvidersCollection(
     ...
     * branded default (Fin/<version> (Android <release>; <model>) — see
     * FinUserAgent.DEFAULT) at request build time. Cloned from
