...
import com.mrmusic.fin.scheduled.ScheduledRepeatMode
import com.mrmusic.fin.scheduled.ScheduledTargetMode
import com.mrmusic.fin.scheduled.ScheduledTask
import com.mrmusic.fin.scheduled.ScheduledTaskManager
...
class ScheduledTaskOffloadHandler(private val context: Context) : NativeOffloadHandler {
    ...
    private fun handleRun(args: OffloadArgs): NativeOffloadResult {
        ...
        val sessionId = runBlocking {
            com.mrmusic.fin.scheduled.ScheduledAgentRunner.run(context, task)
        }
        val out = JSONObject()
            .put("id", id)
