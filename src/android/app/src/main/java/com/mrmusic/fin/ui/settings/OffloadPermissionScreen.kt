...
import com.mrmusic.fin.offload.ShizukuManager
...
fun OffloadPermissionScreen(
    ...
    val configEnabled by com.mrmusic.fin.config.MinisConfigPermissionStore.enabled.collectAsState()
    ...
    LaunchedEffect(Unit) {
        ...
        while (true) {
            a11yEnabled = isA11yServiceEnabled(context) || FinAccessibilityService.getInstance() != null
            delay(1000)
        }
    }
    ...
    SettingsScaffold(
        ...
        onBack = onBack,
        actions = {
            FinTextButton(onClick = { showResetConfirm = true }) {
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = {
                    com.mrmusic.fin.config.MinisConfigPermissionStore.setEnabled(it)
                },
                showDivider = false,
            )
        }
        ...
        AlertDialog(
            ...
            confirmButton = {
                FinTextButton(onClick = {
                    ...
                    com.mrmusic.fin.config.MinisConfigPermissionStore.setEnabled(true)
            ...
            dismissButton = {
                FinTextButton(onClick = { showResetConfirm = false }) {
...
private fun AgentPolicyRow(
    ...
    Box {
        ...
        FinMenu(expanded = expanded, onDismissRequest = { expanded = false }, alignEnd = true) {
...
private fun isA11yServiceEnabled(context: Context): Boolean {
    val expected = "${context.packageName}/${FinAccessibilityService::class.java.name}"
