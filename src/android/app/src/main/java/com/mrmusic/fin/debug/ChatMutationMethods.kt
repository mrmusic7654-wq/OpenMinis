...
import com.mrmusic.fin.ui.chat.InputAttachment
...
internal object ChatMutationMethods {
    ...
    private fun app(context: Context): FinApp =
     ...
     * [com.mrmusic.fin.ui.chat.ChatViewModelStore]) — unlike [prompt], which
    ...
    suspend fun uiPrompt(context: Context, params: JSONObject): JSONObject {
        ...
        val app = app(context)
        val store = com.mrmusic.fin.ui.chat.ChatViewModelStore
        ...
        val vm = kotlinx.coroutines.withContext(kotlinx.coroutines.Dispatchers.Main) {
            androidx.lifecycle.ViewModelProvider(
                ...
                com.mrmusic.fin.ui.chat.ChatViewModel.factory(
                    sessionId = sessionId,
            ...
            )[com.mrmusic.fin.ui.chat.ChatViewModel::class.java].also { it.sendMessage(text) }
        }
    ...
    suspend fun status(context: Context, params: JSONObject): JSONObject {
        ...
        return JSONObject().apply {
            ...
            put("isRunning", com.mrmusic.fin.service.SessionActivityTracker.isActive(sessionId))
