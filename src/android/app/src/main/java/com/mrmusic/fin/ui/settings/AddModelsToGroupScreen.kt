...
import com.mrmusic.fin.ui.components.PickerModalityFilter
import com.mrmusic.fin.ui.components.modelEntryPickerItems
...
fun AddModelsToGroupScreen(
    ...
    var quickTestEntry by remember { mutableStateOf<com.mrmusic.fin.data.model.ModelEntry?>(null) }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    FinTextButton(onClick = onBack) { Text(stringResource(R.string.common_cancel)) }
                    FinButton(
                        onClick = {
