...
import com.mrmusic.fin.data.db.ChatDao
...
class ChatRepository(internal val dao: ChatDao) {
     ...
     * from [com.mrmusic.fin.data.model.ContentPart]: "toolUse" / "toolResult"
     ...
     * [com.mrmusic.fin.ui.chat.ChatViewModel.rerunFromToolBlock]'s block-
    ...
    /**
     * Paginated raw [MessageEntity] page — used by [com.mrmusic.fin.share.ChatExporter]
