...
fun EnvironmentVariablesScreen(
    ...
    val privacyEnabled by com.mrmusic.fin.data.EnvVarPrivacyStore.enabled.collectAsState()
    ...
    SettingsScaffold(
        ...
        SettingsSection(
            ...
            SettingsSwitchRow(
                ...
                onCheckedChange = { com.mrmusic.fin.data.EnvVarPrivacyStore.setEnabled(it) },
                showDivider = false,
            )
        }
    ...
    if (deleteEntryId != null) {
        ...
        AlertDialog(
            ...
            dismissButton = {
                FinTextButton(onClick = { deleteEntryId = null }) {
