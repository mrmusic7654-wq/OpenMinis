package com.mrmusic.fin.notification
 ...
 *
 * Trigger contract: this class is hooked into [com.mrmusic.fin.service.SessionActivityTracker]
...
class BackgroundTaskNotifier(
    ...
    /**
     * Called by [com.mrmusic.fin.service.SessionActivityTracker] when a
     ...
     * [CHANNEL_ID] channel. Called from FinApp's foreground transition
