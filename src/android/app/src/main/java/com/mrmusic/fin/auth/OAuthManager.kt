...
abstract class OAuthManager(
    ...
    companion object {
        ...
        fun forInstance(context: Context, instance: com.mrmusic.fin.data.model.ProviderInstance): OAuthManager? {
            return when (instance.providerType) {
                com.mrmusic.fin.data.model.ProviderType.anthropic -> ClaudeOAuthManager(context, instance.id)
                com.mrmusic.fin.data.model.ProviderType.openAI -> OpenAIOAuthManager(context, instance.id)
                com.mrmusic.fin.data.model.ProviderType.xAI -> XAIOAuthManager(context, instance.id)
                com.mrmusic.fin.data.model.ProviderType.kimiCode -> KimiOAuthManager(context, instance.id)
                else -> null
            }
        }
    }
    ...
    private fun getEncryptedPrefs() =
        com.mrmusic.fin.util.EncryptedPrefsFactory.safeCreate(context, "oauth_prefs")
